...
//NOTE: part 1 of patch to make write work. Part 2 is the whole hid_write function
...
//NOTE: all code inside this function is part 2 of the patch. Part 1 is in the defnies at the top of the page.
int HID_API_EXPORT HID_API_CALL hid_write(hid_device *dev, const unsigned char *data, size_t length)
{
	...
	if (!res) {
		if (GetLastError() != ERROR_IO_PENDING) {
			...
			register_string_error(dev, L"Send Output Report DeviceIoControl");
			return -1;
		}
	}
